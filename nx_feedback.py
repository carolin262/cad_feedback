...
class Feedback_client_Nx:
    ...
    def sort_column(self, column):
        #self.sort_column(self.nx_dataframe['semester'])
        x = []
        y = []
        for i in column:
            if i in x:
...
if __name__=='__main__':
    feedback_obj=Feedback_client_Nx('Nx')
